...
for {set i $start} {$i <= $stop} {incr i $step} {
    ...
    set PBPA [atomselect $mol "index [$selPB get index] and within 6.1 of index [$selPA get index]"]} result]} {
    set area_PP 0 } else {
    ...
    set NPB [atomselect $mol "index [$selNPB get index] and within 6.1 of index [$selNPA get index]"]} result]} {
    ...
    set NPBPA [atomselect $mol "index [$selNPB get index] and within 6.1 of index [$selPA get index]"]} result]} {
    ...
    set PBNPA [atomselect $mol "index [$selPB get index] and within 6.1 of index [$selNPA get index]"]} result]} {
